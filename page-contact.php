	...
	<div id="map"></div>
		...
		<div class="contact-numbers">
			...
			<div class="each-person">
				...
				<p class="name">Sarah Power</p>
				<p class="phone-number">416-459-9578</p>
			</div>
			<div class="each-person">
			...
			<div class="each-person">
				...
				<p class="name">Christina Koichopolos</p>
				<p class="phone-number">905-831-1717</p>
			</div>
			<div class="each-person">
			...
			<div class="each-person">
				...
				<p class="name">Paul Locke</p>
				<p class="phone-number">416-729-7558</p>
			</div>
			<div class="each-person">
			...
			<div class="each-person">
				...
				<p class="phone-number">416-902-5094</p>
			</div>
			<div class="each-person">
			...
			<div class="each-person">
				<p class="position">Social Committee</p>
				<p class="phone-number">Contact President<br> if Interested</p>
			</div>
		</div>
